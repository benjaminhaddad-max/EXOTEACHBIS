...
| 2026-03-27 | `028_post_attachments.sql`, `upload-attachment`, `annonces-tab.tsx`, `annonces-shell.tsx`, `annonces/actions.ts`, page élève `annonces` | Annonces : pièces jointes images (JPEG/PNG/GIF/WebP) + PDF, upload Supabase Storage, colonne `posts.attachments` jsonb, aperçu admin + élève |
