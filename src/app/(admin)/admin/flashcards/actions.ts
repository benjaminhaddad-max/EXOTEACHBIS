...
export async function createDeck(data: { name: string; description?: string; matiere_id?: string | null; cours_id?: string | null }) {
...
export async function updateDeck(id: string, data: { name: string; description?: string; matiere_id?: string | null; cours_id?: string | null; visible?: boolean }) {
  const supabase = await createClient();
